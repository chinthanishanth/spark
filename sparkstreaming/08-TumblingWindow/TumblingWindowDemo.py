...
if __name__ == "__main__":
    ...
    # NOTE: tumbling time window is equalent to groupby window function
    ...
    # window_agg_df.printSchema() # NOTE: used to check schema of the dataframe output
    output_df = window_agg_df.select(
        "window.start", "window.end", "TotalBuy", "TotalSell")
