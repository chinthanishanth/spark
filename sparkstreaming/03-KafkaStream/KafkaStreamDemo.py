...
if __name__ == "__main__":
    spark = SparkSession\
        ...
        .getOrCreate()
    # .config("spark.jars.packages","org.apache.spark:spark-sql-kafka-0-10_2.12:3.0.3") # jar to communicate kafka with spark
    # This setting can be place in spark-defaults.conf file
